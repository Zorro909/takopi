...
from takopi.matrix.bridge import (
    _is_cancel_command,
    _parse_slash_command,
    MatrixPresenter,
    MatrixTransport,
)
from takopi.matrix.types import MatrixIncomingMessage, MatrixReaction
...
def test_cancel_reactions_include_x() -> None:
    ...
    from takopi.matrix.bridge import _CANCEL_REACTIONS
